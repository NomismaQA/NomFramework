...
public class TC40subscriptweeklyemployeeTS6 extends TestBase
{
...
//  _runpayrollpage.AssertUrl();
  ...
  frequency.filingmanagementforfrequency _leavertesting = new frequency.filingmanagementforfrequency(driver);
