...
public class TC577SMP_XMLFourWeekly10 extends TestBase
{
...
//    _payslip.AssertUrl();
    ...
    XML_SMP_Page.XML_SMPCheck DsbData = new XML_SMP_Page.XML_SMPCheck(driver);
...
//    _CDBeforeTxYrLow.AssertUrl();
    ...
    DsbData.Click_gotoReports();
    

    XML_SMP_Page.PayslipEmail _PayslipEmail = new XML_SMP_Page.PayslipEmail(driver);
    
    TestModellerLogger.SetLastNodeGuid("a3114323-8699-4e92-bfd2-109f8a19b5a4");
    _PayslipEmail.Click_Payslips();
    

    TestModellerLogger.SetLastNodeGuid("d720fce1-93f8-4677-9b57-a94271a3661f");
    _PayslipEmail.Click__Email_Payslips();
    

//    TestModellerLogger.SetLastNodeGuid("7d2d1532-2fb4-49d4-814c-73393317bcf2");
//    _PayslipEmail.Click_Company_email_address();
    

    TestModellerLogger.SetLastNodeGuid("998a1735-8894-4923-8996-bd5a649c6f85");
    _PayslipEmail.Click__Send_();
