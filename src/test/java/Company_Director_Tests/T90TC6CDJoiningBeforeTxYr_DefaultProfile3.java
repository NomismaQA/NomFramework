...
public class T90TC6CDJoiningBeforeTxYr_DefaultProfile3 extends TestBase
{
...
//
    ...
    Company_Director.TC6CDJoiningBeforeTxYr_DefaultProfile3 getAnnualPay = new Company_Director.TC6CDJoiningBeforeTxYr_DefaultProfile3(driver);
   
    TestModellerLogger.SetLastNodeGuid("f2ba1cf7-8019-409e-8d55-d9615b60e8f9");
    getAnnualPay.Click_clickPayDetails();
    

    TestModellerLogger.SetLastNodeGuid("ea3cf16d-46bf-48e2-99c6-c3151fb7cf46");
    getAnnualPay.Enter_getAnnualSalary();
    
    	
    	
//    	TestModellerLogger.SetLastNodeGuid("2bcaf9ea-83a6-4f81-a0f6-66c4b11352ba");
//    	_Empfrqchange.Click_gotoReports();
//        
//
//        TestModellerLogger.SetLastNodeGuid("d437f8e0-ccd6-477b-850b-083134cf5564");
//        _Empfrqchange.Click_click_P60P45P11D_Forms();
//        
//
//        TestModellerLogger.SetLastNodeGuid("05ce9884-9587-46af-9d04-86e5658dbdd4");
//        _Empfrqchange.Click_clickP60_PDF_DocumentIcon();
//        
