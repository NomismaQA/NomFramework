package _2099PreviousEmployment;
...
public class TC830_837EE_Previous_Yr_Detail extends TestBase
{
...
//  _searchEmployee.AssertUrl();
  ...
  _searchEmployee.Select_selectTaxYearsoption(data[7]);
...
_searchEmployee.verifyPreviousYrData();
...
//    
  ...
  _searchEmployee.verifyCurrentYrData();
    }
...
//    
    ...
    @TestModellerPath(guid = "90798a2f-7a6d-4763-802e-d996fa55fb26")
    public void GoToUrlAssertUrlPositiveEnterEnterUsernamePositiveEnterEnterpasswordClickLoginButtonGoToUrlAs8() throws Exception
    {
