...
public class TC661StarterDetailnotVisibleReportsof2Weekly extends TestBase
{
...
//    _AllowenceScheme.verifysummaryformonthlywhenQuaterly();
    ...
    _2134.QuarteryDataCheckforSummary _QuarteryDataCheckforSummary = new _2134.QuarteryDataCheckforSummary(driver);


    TestModellerLogger.SetLastNodeGuid("1a9fe747-e43e-4a1e-9b0f-8e26d10a1216");
    _QuarteryDataCheckforSummary.Select_selectPayrollDate(data[5]);
    
    TestModellerLogger.SetLastNodeGuid("4575d0b4-2644-47c6-910c-776f8c4d6761");
    _QuarteryDataCheckforSummary.VrfyStarter();
    
    
//    TestModellerLogger.SetLastNodeGuid("4575d0b4-2644-47c6-910c-776f8c4d6761");
//    _QuarteryDataCheckforSummary.VrfyLeaver();
