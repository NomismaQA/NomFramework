package _2128AutoPayProtection;
...
public class TC636PaysliptoERandOtherwithPeriodOptionwithPDFProtection extends TestBase
{
...
//  _PayslipOfReports.AssertUrl();
  ...
  _PayslipOfReports.Select_PeriodDate(data[6]);
  

  TestModellerLogger.SetLastNodeGuid("8340deb8-a0b9-405c-b0cb-c9bcb68e045b");
  _PayslipOfReports.Select_EmailTo(data[7]);
  ...
  _PayslipOfReports.EnterOtherEmail(data[8]);
