...
public class TC635PaysliptoERandOtherwithPeriodOption extends TestBase
{
...
//  _PayslipOfReports.AssertUrl();
  ...
  _PayslipOfReports.Select_PeriodDate(data[5]);
  ...
  _PayslipOfReports.EnterOtherEmail(data[7]);
