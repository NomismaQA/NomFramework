...
public class TC196_ToalpaymentofSubcontrorinsummary extends TestBase
{
...
//_verifyClosePayeErrorMessage.AssertUrl();
  ...
  _verifyClosePayeErrorMessageOOPS.Click_ClickPayroll();
	...
	_1942_2010page.summaryverify amountverify = new _1942_2010page.summaryverify(driver);
	
	
	amountverify.verifysubcontratorAmount();
