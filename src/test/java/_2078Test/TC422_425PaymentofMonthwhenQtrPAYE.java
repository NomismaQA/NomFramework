...
public class TC422_425PaymentofMonthwhenQtrPAYE extends TestBase
{
...
//	  pages.frequency.runpayrollpage1 _runpayrollpage = new runpayrollpage1(driver);
	  ...
	  TestModellerLogger.SetLastNodeGuid("23be5cc2-a814-441a-bd93-1259e9cd737c");
	    ...
	    _2078PaymentOfMonth.EnableAllowenceScheme  enableAllowence=new _2078PaymentOfMonth.EnableAllowenceScheme(driver);
	    

	    TestModellerLogger.SetLastNodeGuid("3517f720-6625-4f86-9d29-386402999915");
	    enableAllowence.Click_clickAllowances_Schemes();
	    
	    
	    TestModellerLogger.SetLastNodeGuid("3517f720-6625-4f86-9d29-386402999915");
	    enableAllowence.Click_markYes();
