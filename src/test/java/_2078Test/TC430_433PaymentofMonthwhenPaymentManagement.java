...
public class TC430_433PaymentofMonthwhenPaymentManagement extends TestBase
{
...
//	  pages.frequency.runpayrollpage1 _runpayrollpage = new runpayrollpage1(driver);
	  ...
	  TestModellerLogger.SetLastNodeGuid("23be5cc2-a814-441a-bd93-1259e9cd737c");
	    ...
	    _2078PaymentOfMonth.EnablePaymentMmgt  enablePaymentManagement=new _2078PaymentOfMonth.EnablePaymentMmgt(driver);
	    

	    TestModellerLogger.SetLastNodeGuid("3517f720-6625-4f86-9d29-386402999915");
	    enablePaymentManagement.Click_MarkYestoPaymentMmgt();
	    
	    
	    TestModellerLogger.SetLastNodeGuid("3517f720-6625-4f86-9d29-386402999915");
	    enablePaymentManagement.Click_clickSave();
...
//	  enableAllowence.Click_clickSave();
...
// _OpenClient.AssertUrl();
 ...
 _OpenClient.Click_ClickClient();
    ...
    TestModellerLogger.SetLastNodeGuid("2aa697e3-aa8e-4555-92d8-649a53ec1836");
    enablePaymentManagement.markNO();
