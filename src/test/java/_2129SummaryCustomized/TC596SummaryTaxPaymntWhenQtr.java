...
public class TC596SummaryTaxPaymntWhenQtr extends TestBase
{
...
// _OpenClient.AssertUrl();
 ...
 verifyClosePayeErrorMessageOOPS _verifyClosePayeErrorMessageOOPS = new verifyClosePayeErrorMessageOOPS(driver);
 		...
 		_2129pages.TaxPayment _TaxPayment = new _2129pages.TaxPayment(driver);

	    TestModellerLogger.SetLastNodeGuid("25154369-7bfc-4262-9657-22be161ad383");
	    _TaxPayment.Click__Tax_Payment_();
	    
	    
	    TestModellerLogger.SetLastNodeGuid("25154369-7bfc-4262-9657-22be161ad383");
	    _TaxPayment.Click_Amount_due_to_HMRC();
	    
	    
	    TestModellerLogger.SetLastNodeGuid("25154369-7bfc-4262-9657-22be161ad383");
	    _TaxPayment.verifyAmoutDue();
