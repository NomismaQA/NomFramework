...
public class TC182EPSwhenCIS extends TestBase
{
...
//    _payslip.AssertUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("cd342f2a-6174-45a8-825e-cfb2a6fc10fc");
    _payslip.Click_gotoTaxPayment();
    
    
    _payslip.Click_ClickCISSuffered();
    
    
    _payslip.Enter_CIS_Amount(data[5]);
    
    
    TestModellerLogger.SetLastNodeGuid("300a58c3-f94e-454a-a07e-b59f42067db9");
    _payslip.Click_clickSave1();
