...
public class TC292AttachmentwhenCIS extends TestBase
{
...
// _OpenClient.AssertUrl();
 ...
 _OpenClient.Click_ClickClient();
    ...
    VerifyEmailsData.PayrollSummaryData _QuarteryDataCheckforSummary = new VerifyEmailsData.PayrollSummaryData(driver);
...
//    _PayrollSummaryEmail.AssertUrl();
    ...
    TestModellerLogger.SetLastNodeGuid("1a9fe747-e43e-4a1e-9b0f-8e26d10a1216");
    _PayrollSummaryEmail.getSummaryData();
    
    
    TestModellerLogger.SetLastNodeGuid("1a9fe747-e43e-4a1e-9b0f-8e26d10a1216");
    _PayrollSummaryEmail.getCISfromSummaryData();
...
//    _PayrollSummaryEmail.Enter_SendEmailtoOther(data[5]);
    

    TestModellerLogger.SetLastNodeGuid("585d6047-c3ea-44ce-b744-d633d4c9b475");
    _PayrollSummaryEmail.summaryAttachment();
...
//    _PayrollSummaryEmail.readPDF();
//    
    
//    TestModellerLogger.SetLastNodeGuid("185b03fd-051a-4d99-8182-b53d6a469a02");
//    _PayrollSummaryEmail.validateAttachment();
    
    
//    TestModellerLogger.SetLastNodeGuid("185b03fd-051a-4d99-8182-b53d6a469a02");
//    _PayrollSummaryEmail.validateAttachmentWhenCIS();
