...
public class verifyEmail_DefaultProfilesample extends TestBase
{
...
//    _payslip.AssertUrl();
    ...
    _payslip.Click_ClickPayroll();
    	...
    	VerifyEmailsData.verifyEmailsample _verifyEmail = new VerifyEmailsData.verifyEmailsample(driver);
