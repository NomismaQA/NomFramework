...
public class TC504NewContractorFields extends TestBase
{
...
//    
    ...
    _1744CISDSB.NewContractor _NewContractor = new _1744CISDSB.NewContractor(driver);
    
    _NewContractor.Click__New_Contractor();
    
    
    _NewContractor.Enter_ContractorName(data[4]);
    
    _NewContractor.Enter_PhoneNo(data[5]);
    
    
    _NewContractor.Enter_ContractoeFirstName(data[6]);
    
    
    _NewContractor.Enter_EmailId(data[7]);
    
    
    _NewContractor.Enter_ContractorSurName(data[8]);
    
    
    _NewContractor.Enter_Address1(data[9]);
    
    
    _NewContractor.Enter_OfficeNo(data[10]);
    
    
    _NewContractor.Enter_ContractorRefNo2(data[11]);
    
    
    _NewContractor.Enter_Address2(data[12]);
    
    
    _NewContractor.Enter_AccountOffRefNo(data[13]);
    
    
    _NewContractor.Enter_Address3(data[14]);
    
    
    _NewContractor.Enter_UtrNo(data[15]);
    
    
    _NewContractor.Enter_PostCode(data[16]);
