...
public class TC60subscriptEPSwhenCISSuffered extends TestBase
{
...
//    _payslip.AssertUrl();
    ...
    EPS.EPSWhenCISSuffered CISENTRY=new EPS.EPSWhenCISSuffered(driver);
    
    CISENTRY.Click_gotoTaxPayment();
