...
public class TC61subscriptEPSwhenApperentice extends TestBase
{
...
//    frequency.RunPayroll _payslip = new frequency.RunPayroll(driver);
...
//    _payslip.AssertUrl();
    ...
    EPS.EPSWhenApperentice CISENTRY=new EPS.EPSWhenApperentice(driver);
    
    TestModellerLogger.SetLastNodeGuid("b8f497b9-33c0-4c39-bf26-595e889fe36f");
    CISENTRY.Click_ClickPayroll();
    
    
    CISENTRY.Click_gotoFilingManagement();
...
//    frequency.gotofilingmanagement1 eps=new frequency.gotofilingmanagement1(driver);
//    
//    eps.Click_gotoFilingManagement();
//   
