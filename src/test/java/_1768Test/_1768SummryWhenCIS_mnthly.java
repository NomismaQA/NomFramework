...
public class _1768SummryWhenCIS_mnthly extends TestBase
{
...
//    _AllowenceScheme.verifysummaryformonthlywhenQuaterly();
    ...
    verifySummaryReportData.MonthlyDataCheckforSummary _QuarteryDataCheckforSummary = new verifySummaryReportData.MonthlyDataCheckforSummary(driver);
...
//    _QuarteryDataCheckforSummary.AssertUrl();
    ...
    _QuarteryDataCheckforSummary.Select_selectTaxYears(data[6]);
    
    
    TestModellerLogger.SetLastNodeGuid("1a9fe747-e43e-4a1e-9b0f-8e26d10a1216");
    _QuarteryDataCheckforSummary.checkbalanceOwedMntlyWhenCIS();
