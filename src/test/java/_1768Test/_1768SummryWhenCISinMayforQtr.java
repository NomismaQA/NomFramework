...
public class _1768SummryWhenCISinMayforQtr extends TestBase
{
...
//	    _AllowenceScheme.AssertUrl();
	    ...
	    TestModellerLogger.SetLastNodeGuid("fe297d44-a712-442e-9d2c-2c2489254660");
 	    _AllowenceScheme.allowenceYesNo();
 		
 		
 		 pages1.PaymentManagementForQtrPaye _PaymentManagement = new pages1.PaymentManagementForQtrPaye(driver);  
		   
		    TestModellerLogger.SetLastNodeGuid("4906364b-7b2c-4239-84e8-da251b4cd428");
		    _PaymentManagement.Click_gotoTaxPayment();
		    
		    
		    Quaterly_Paye_Scheme.CISEntry1 _CISEntry = new Quaterly_Paye_Scheme.CISEntry1(driver);
...
//		    _CISEntry.Enter_EnterAmount(data[5]);
		    

		    TestModellerLogger.SetLastNodeGuid("30260b13-9b04-4dee-b598-276340ae3252");
		    _CISEntry.Click_clickSave1();
		    
		    
//	_1964_RunPayroll.Gross_Pay_Calculation _Gross_Pay_Calculation = new _1964_RunPayroll.Gross_Pay_Calculation(driver);	
...
//    _AllowenceScheme.verifysummaryformonthlywhenQuaterly();
    ...
    verifySummaryReportData.CISinMayWhenQtr _QuarteryDataCheckforSummary = new verifySummaryReportData.CISinMayWhenQtr(driver);
...
//
    ...
    _QuarteryDataCheckforSummary.setEmploymentAllowance();
    ...
    TestModellerLogger.SetLastNodeGuid("4575d0b4-2644-47c6-910c-776f8c4d6761");
    _QuarteryDataCheckforSummary.Select_selectPayrollDate(data[6]);
    
    
    TestModellerLogger.SetLastNodeGuid("1a9fe747-e43e-4a1e-9b0f-8e26d10a1216");
    _QuarteryDataCheckforSummary.CISforQtrinMay();
