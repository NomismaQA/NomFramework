...
public class TC36subscriptNoAllowenceScheme_DefaultProfile extends TestBase
{
...
//  _verifyClosePayeErrorMessage.AssertUrl();
  ...
  pages1.NoAllowenceScheme _AllowenceScheme = new pages1.NoAllowenceScheme(driver);
