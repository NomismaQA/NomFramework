...
public class TC38CIS_With_Disable_Scheme_test extends TestBase
{
    ...
    public void GoToUrlAssertUrlPositiveEnterEnterUsernamePositiveEnterEnterpasswordClickLoginButtonGoToUrlAs() throws Exception
    {
			...
			//  _verifyClosePayeErrorMessage.AssertUrl();
			  ...
			  Quaterly_Paye_Scheme.CIS_With_Disable_Scheme gotoReports = new Quaterly_Paye_Scheme.CIS_With_Disable_Scheme(driver);
...
//		    _CISEntry.Enter_EnterAmount("100");
		    ...
		    Quaterly_Paye_Scheme.CISEntry1 _CISEntry1 = new Quaterly_Paye_Scheme.CISEntry1(driver);
		    TestModellerLogger.SetLastNodeGuid("30260b13-9b04-4dee-b598-276340ae3252");
		    _CISEntry1.Click_clickSave1(); 
