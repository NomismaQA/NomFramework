...
public class T39CIS_With_Enable_PaySchemetest extends TestBase
{
    ...
    public void GoToUrlAssertUrlPositiveEnterEnterUsernamePositiveEnterEnterpasswordClickLoginButtonGoToUrlAs() throws Exception
    {
			...
			//  _verifyClosePayeErrorMessage.AssertUrl();
			  ...
			  Quaterly_Paye_Scheme.CIS_With_Enable_PayScheme gotoReports = new Quaterly_Paye_Scheme.CIS_With_Enable_PayScheme(driver);
...
//			    _AllowenceScheme.AssertUrl();
			    ...
			    gotoReports.Click_clickAllowances_Schemes();
