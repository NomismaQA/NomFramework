...
public class TC76subscriptT12EmployemntAllowence extends TestBase
{
...
//  _verifyClosePayeErrorMessage.AssertUrl();
  ...
  Quaterly_Paye_Scheme.T12EmployemntAllowence T12EA = new Quaterly_Paye_Scheme.T12EmployemntAllowence(driver);


    TestModellerLogger.SetLastNodeGuid("60585696-efea-430a-b012-bacf6202f632");
    T12EA.Click_clickAllowances_Schemes();
