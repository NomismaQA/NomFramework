...
public class TC37subscriptAllowenceSchemewithpaymentMngmnt_DefaultProfile extends TestBase
{
...
Quaterly_Paye_Scheme.AllowenceSchemewithpaymentMangmnt _AllowenceScheme = new Quaterly_Paye_Scheme.AllowenceSchemewithpaymentMangmnt(driver);
...
//    _AllowenceScheme.Click_clickSave();
    ...
    Quaterly_Paye_Scheme.PaymentManagementForQtrPaye _PaymentManagement = new Quaterly_Paye_Scheme.PaymentManagementForQtrPaye(driver); 
    ...
    _PaymentManagement.Enter_EnterNICActualPaidAmount1(data[5]);
    ...
    _AllowenceScheme.Select_SelectPayrollMonthDate(data[6]);
