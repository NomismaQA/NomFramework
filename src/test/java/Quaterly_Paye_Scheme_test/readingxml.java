...
public class readingxml extends TestBase
{
...
//  _verifyClosePayeErrorMessage.AssertUrl();
  ...
  _verifyClosePayeErrorMessageOOPS.Click_ClickPayroll();
	...
	Quaterly_Paye_Scheme.filingxmlverification _xmlReading = new Quaterly_Paye_Scheme.filingxmlverification(driver);
//    TestModellerLogger.SetLastNodeGuid("c1ca4ec1-a61a-4792-a6d0-643bd072bb95");
//    _xmlReading.GoToUrl();
//    
//
//    TestModellerLogger.SetLastNodeGuid("53d56a44-5e1e-4e3f-95ec-22565b423e07");
//    _xmlReading.AssertUrl();
    

    TestModellerLogger.SetLastNodeGuid("941bd579-df6b-4ba5-bb3c-18b445b199d2");
    _xmlReading.Click_gotoFiling_Management();
    

    TestModellerLogger.SetLastNodeGuid("1307f784-b2db-4870-b17a-41432b907910");
    _xmlReading.Click_clickFPS();
    

    TestModellerLogger.SetLastNodeGuid("61d57b9b-800a-4857-81a9-1cfc8cd6f2ae");
    _xmlReading.Enter_getXMLData();
    
    
    _xmlReading.checkXML();
