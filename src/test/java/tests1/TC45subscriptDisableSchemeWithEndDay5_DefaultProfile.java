...
public class TC45subscriptDisableSchemeWithEndDay5_DefaultProfile extends TestBase
{
...
//  _verifyClosePayeErrorMessage.AssertUrl();
  ...
  pages1.DisableSchemeWithEndDay5 _AllowenceScheme = new pages1.DisableSchemeWithEndDay5(driver);
