...
//    
  ...
  /*  @Test  (groups= {"subscript","subscript - Default Profile"})
    @TestModellerPath(guid = "8843c181-34f1-466f-a5ee-75fa1fc53a94")
    ...
    TestModellerLogger.SetLastNodeGuid("a3b75c02-20d9-486b-b363-d5655bc9c912");
    _loginpage.Enter_EnterUsername("Gina60");
    

    TestModellerLogger.SetLastNodeGuid("a87badd2-779d-47bb-adfe-a3d7a64299d2");
    _loginpage.Enter_Enterpassword("NL0656nSDY");
...
pages.agentpage _agentpage = new pages.agentpage(driver);
    ...
    TestModellerLogger.SetLastNodeGuid("4f74cb0a-4c80-4c19-a49b-294b2920cf03");
    _agentpage.Enter_SearchAgentName("dicta");
...
pages.deregistercompany _deregistercompany = new pages.deregistercompany(driver);
    ...
    TestModellerLogger.SetLastNodeGuid("5b939b97-177b-46c4-8a72-05a1c721dc67");
    _deregistercompany.Enter_EnterDeRegistrationDate("44274.55952790509");
...
pages.verifypage _verifypage = new pages.verifypage(driver);
    ...
    @Test  (groups= {"subscript","subscript - Default Profile"})
    @TestModellerPath(guid = "a2bde0f2-67de-45c4-b503-b04918514639")
    ...
    TestModellerLogger.SetLastNodeGuid("a3b75c02-20d9-486b-b363-d5655bc9c912");
    _loginpage.Enter_EnterUsername("Sharon_Beer");
    

    TestModellerLogger.SetLastNodeGuid("a87badd2-779d-47bb-adfe-a3d7a64299d2");
    _loginpage.Enter_Enterpassword("juc0jMJLc5");
...
pages.agentpage _agentpage = new pages.agentpage(driver);
    ...
    TestModellerLogger.SetLastNodeGuid("4f74cb0a-4c80-4c19-a49b-294b2920cf03");
    _agentpage.Enter_SearchAgentName("aut");
...
pages.OpenClient _OpenClient = new pages.OpenClient(driver);
    ...
    TestModellerLogger.SetLastNodeGuid("d0ca1211-df90-488b-a0c0-e841ed6d76a5");
    _OpenClient.Enter_EnterClientName("rerum");
...
pages.activateclient _activateclient = new pages.activateclient(driver);
    ...
    TestModellerLogger.SetLastNodeGuid("16c3aae5-914a-4920-8782-aaf04dddafa7");
    _activateclient.Enter_PayeRegDate("44274.55952790509");
...
pages.deregistercompany _deregistercompany = new pages.deregistercompany(driver);
    ...
    TestModellerLogger.SetLastNodeGuid("5b939b97-177b-46c4-8a72-05a1c721dc67");
    _deregistercompany.Enter_EnterDeRegistrationDate("44274");
