...
import pages.VerifyCompanyStatusInactive;
...
public class TC02CompanyInactiveSubscript_DefaultProfile extends TestBase
{
...
VerifyCompanyStatusInactive _VerifyCompanyStatus = new VerifyCompanyStatusInactive(driver);
