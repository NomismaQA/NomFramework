...
public class TC713_714CheckTaxablePayForTwoMonths10 extends TestBase
{
...
//    _AgentsSetting.Click_ClickSave();
    ...
    pages.Create_Client _CreateClient = new pages.Create_Client(driver);
    
    _CreateClient.Click__New_Client();
    
    _CreateClient.Click_Limited();
    
    _CreateClient.Click_Limited_Company();
    
    _CreateClient.Enter_EnterBusinessCompanyName(data[4]);
    
    _CreateClient.Enter_EnterRegNo(data[5]);
    
    _CreateClient.Enter_RegDate(data[6]);
    
    _CreateClient.Enter_FirstName1(data[7]);
    
    _CreateClient.Enter_LastName1(data[8]);
    
    _CreateClient.Click_Create_Payroll_Profile();
    
 //   _CreateClient.Click__Save_();
