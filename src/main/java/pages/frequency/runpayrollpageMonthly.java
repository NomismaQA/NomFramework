...
public class runpayrollpageMonthly extends BasePage
{
	public runpayrollpageMonthly (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	public void Click_ClickRunPayroll2() throws Exception
	{
		...
		TakeScreenshot.takeScreenshot(m_Driver, "Monthly_Frequency");
