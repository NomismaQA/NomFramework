...
public class runpayrollpageExistingFrequency extends BasePage
{
	public runpayrollpageExistingFrequency (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	public void Click_ClickRunPayroll2() throws Exception
	{
		...
		elem.click();
		TakeScreenshot.takeScreenshot(m_Driver, "ExistingCompanyFrequency");
