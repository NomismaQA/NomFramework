...
public class runpayrollpagefourweekly extends BasePage
{
	public runpayrollpagefourweekly (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	public void Click_ClickRunPayroll2() throws Exception
	{
		...
		elem.click();
		TakeScreenshot.takeScreenshot(m_Driver, "FourWeeklyFrequency");
