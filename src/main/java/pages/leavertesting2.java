...
public class leavertesting2 extends BasePage
{
	public leavertesting2 (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	public void Click_SelectLeaver()
	{
		...
		elem.click();
		System.out.println("before switch1");
     ...
     */
 	public void Enter_EnterLeavingDate(String EnterLeavingDate) throws Exception
 	{
		...
		m_Driver.switchTo().frame(getWebElement(By.xpath("//*[@id='LeaverPopUp']/div/div/div[2]")));
