...
public class payslip_Blue extends BasePage
{
	public payslip_Blue (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	{
		TakeScreenshot.takeScreenshot(m_Driver, "Schedule not visible");
	}
	...
	public void makenotapplicable() throws InterruptedException
	{
		WebElement weekkdate=m_Driver.findElement(By.xpath("//*[@name='ctl00$ctl00$ParentContent$cPH$tbContainer$tppayrollDetails$ddlWeeklyPayDay']"));
		Select Notapplicable=new Select(weekkdate);
      	Thread.sleep(2000);

      	Notapplicable.selectByVisibleText("N/A");
	}
	
	
	public void makenotapplicablefourweekly() throws InterruptedException
	{
		WebElement forweekkdate=m_Driver.findElement(By.xpath("//*[@name='ctl00$ctl00$ParentContent$cPH$tbContainer$tppayrollDetails$ddlFourweeklyPayDay']"));
		Select Notapplicable=new Select(forweekkdate);
      	Thread.sleep(2000);
	...
	public void makenotapplicableFortnightly() throws InterruptedException
	{
		WebElement fornightdate=m_Driver.findElement(By.xpath("//*[@name='ctl00$ctl00$ParentContent$cPH$tbContainer$tppayrollDetails$ddlFortnightlyPayDay']"));
		Select Notapplicable=new Select(fornightdate);
      	Thread.sleep(2000);
