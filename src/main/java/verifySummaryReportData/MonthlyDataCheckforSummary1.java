...
public class MonthlyDataCheckforSummary1 extends BasePage
{
	int i;
	int size;
	int j=4;
	...
	public MonthlyDataCheckforSummary1 (WebDriver driver)
	{
		super(driver);
	}
...
//        	    							assertEquals(Totalamount, PAYE_NIValue,"payment of the month did not matched");
    	        		  				...
    	        		  				{
    	        		  					System.out.println("Hello HMRC");
    	        		  					 ExpectedPayeNI=TaxAmount+EmployeeNIAmount+EmployerNIAmount+BalanceOwedAmount-totalTaxCompensation;
        	        		  				ExpectedPayeNI=(double) (Math.round(ExpectedPayeNI *100)/100.0);
        	        		  				System.out.println("Hello HMRC ExpectedPayeNI="+ExpectedPayeNI);
    	        		  				}
