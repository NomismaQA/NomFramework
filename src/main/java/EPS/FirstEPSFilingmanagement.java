...
public class FirstEPSFilingmanagement extends BasePage
{
	public FirstEPSFilingmanagement (WebDriver driver)
	{
		super(driver);
	}
...
//        
	...
	public void Click_gotoFilingManagement() throws Exception
	{
		...
		String Actualstr=m_Driver.findElement(By.xpath("//*[@id='aspnetForm']/main/div/div[3]/div/div[3]/div/div/div/div/table/tbody/tr[3]/td[5]")).getText();
