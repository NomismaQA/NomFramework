...
public class EmployeeDataInput extends BasePage
{
	public EmployeeDataInput (WebDriver driver)
	{
		super(driver);
	}
...
//		TakeScreenshot.takeScreenshot(m_Driver, "No alert of NMW");
	...
	public void verifyPayrollID() throws Exception 
	{
		...
		WebElement elem=m_Driver.findElement(By.xpath("//Input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtPayId']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Payroll ID Verification");
		
	}


	public void verifyRTISubmission() throws Exception 
	{
		
		WebElement elem=m_Driver.findElement(By.xpath("//Input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtEmployeePayId']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "RTISubmission ID Verification");
	...
	public void verifyFrequency() throws Exception 
	{
		...
		WebElement elem=m_Driver.findElement(By.xpath("//select[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_ddlPayrollFrequencyCode']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Frequency Verification");
		
	}


	public void verifyBankDetail() throws Exception 
	{
		
		WebElement elem=m_Driver.findElement(By.xpath("//Input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtbankName']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Bank Name Verification");
		
		WebElement elem2=m_Driver.findElement(By.xpath("//Input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtBankAccountSortCode']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem2);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "SortCode Verification");
		
		WebElement elem3=m_Driver.findElement(By.xpath("//Input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtBankAccount']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Bank Account Number Verification");
		
	}


	public void verifyNICatogery() throws Exception 
	{
		
		jsExec.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		
		WebElement elem3=m_Driver.findElement(By.xpath("//select[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_ddlNICategoryCode']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Imported NI catogery of Employee");
		
	}


	public void verifyTaxCode() throws Exception 
	{
		
		jsExec.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		
		WebElement elem3=m_Driver.findElement(By.xpath("//Input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtTaxCode']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Imported Tax Code of Employee");
		
	}


	public void verifyDirectorData() throws Exception 
	{
		
		jsExec.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		
		WebElement elem3=m_Driver.findElement(By.xpath("//select[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_ddlDirectorMethod']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Imported Directed Method of Employee");
		
	}


	public void verifySalary() throws Exception 
	{
		
		//jsExec.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		
		WebElement elem3=m_Driver.findElement(By.xpath("//input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtBasicSalary']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Imported Salary of Employee");
		
	}


	public void verifyApprenticeDat() throws Exception 
	{
		
		jsExec.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		
		WebElement elem3=m_Driver.findElement(By.xpath("//input[@id='ctl00_ctl00_ParentContent_cPH_tbContainer_tpPayrollEmployee_txtApprenticeship']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Imported Apprentice Date of Employee");
		
	}


	public void verifyOPeningBalance() throws Exception 
	{
		...
		WebElement elem3=m_Driver.findElement(By.xpath("//input[@id='ctl00_ctl00_ParentContent_cPH_txtYtdEmployeePension']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Imported Opening balance of Employee");
		
		m_Driver.switchTo().defaultContent();
	}


	public void verifyPensionBalance() throws Exception 
	{
		
		m_Driver.switchTo().frame(getWebElement(By.xpath("/html/body/form/main/div/div[3]/div/div[2]/div/div/div[3]/div/div/div[2]/iframe")));
		
		WebElement elem3=m_Driver.findElement(By.xpath("//input[@id='ctl00_ctl00_ParentContent_cPH_txtYtdEmployerPension']"));
		
		jsExec.executeScript("arguments[0].setAttribute('style', 'background: yellow; border: 2px solid red;');", elem3);
		
		Thread.sleep(1000);
		
		TakeScreenshot.takeScreenshot(m_Driver, "Imported Pension balance of Employee");
