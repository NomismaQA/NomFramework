...
public class TC02_GrossPay1 extends BasePage
{
	public TC02_GrossPay1 (WebDriver driver)
	{
		super(driver);
	}
...
int tableSize=m_Driver.findElements(By.xpath("//*[@id='ctl00_ctl00_ParentContent_cPH_gridDisplayRecords']/tbody/tr")).size();
		...
		for(int i=2;i<=tableSize;i++)
		{
			...
			m_Driver.findElement(By.xpath("//*[@id='ctl00_ctl00_ParentContent_cPH_gridDisplayRecords']/tbody/tr["+i+"]/td[12]/div/ul/li[3]/a")).click();
			
		//	System.out.println("Process Pay");
			Thread.sleep(2000);
			
			String basic=m_Driver.findElement(By.xpath("//*[@id='ctl00_ctl00_ParentContent_cPH_txtBasicPay']")).getAttribute("value");
			
			float basicValue=Float.parseFloat(basic);
			...
			float AdditioValue=Float.parseFloat(Addition);
			
			float totalPay=basicValue+AdditioValue;
			
			System.out.println("totalPay="+totalPay);
			
			Thread.sleep(2000);
			
			m_Driver.findElement(By.xpath("//*[@id='ctl00_ctl00_ParentContent_SideMenu1_hrefPayroll']")).click();
			
			Thread.sleep(1000);
			
			String basicSal=m_Driver.findElement(By.xpath("//*[@id='ctl00_ctl00_ParentContent_cPH_gridDisplayRecords']/tbody/tr["+i+"]/td[4]")).getText();
			basicSal=basicSal.replaceAll("[£]", "");
			basicSal=basicSal.replaceAll("[,]", "");
			
			float basicSalValue=Float.parseFloat(basicSal);
			
			assertEquals(totalPay, basicSalValue,"Basic salary not match");
