...
public class filingmanagementforfrequencyweeklyleaver extends BasePage
{
	public filingmanagementforfrequencyweeklyleaver (WebDriver driver)
	{
		super(driver);
	}
...
//        
	...
	public void Click_gotoFilingManagement() throws Exception
	{
		...
		int Tablesize=m_Driver.findElements(By.xpath("//*[@id='aspnetForm']/main/div/div[3]/div/div[3]/div/div/div/div/table/tbody/tr/td[6]")).size();
		System.out.println(" Tablesize "+Tablesize);
		String previousmonth="";
		String currentmonth="";
		for(int i=2; i<=Tablesize+1; i++)
		{
			String Monthstr=m_Driver.findElement(By.xpath("//*[@id='aspnetForm']/main/div/div[3]/div/div[3]/div/div/div/div/table/tbody/tr["+i+"]/td[6]")).getText();
			//System.out.println("Monthstr "+Monthstr);
			String matched="0";
			if(Monthstr.equalsIgnoreCase(matched))
			{
				String EPSstr=m_Driver.findElement(By.xpath("//*[@id='aspnetForm']/main/div/div[3]/div/div[3]/div/div/div/div/table/tbody/tr["+i+"]/td[5]")).getText();
				System.out.println("EPSstr "+EPSstr);
				String expectedeps="EPS";
				assertEquals(EPSstr, expectedeps);
				String DateofMonthstr=m_Driver.findElement(By.xpath("//*[@id='aspnetForm']/main/div/div[3]/div/div[3]/div/div/div/div/table/tbody/tr["+i+"]/td[3]")).getText();
				System.out.println("DateofMonthstr "+DateofMonthstr);
				String DateofMonths[]=DateofMonthstr.split("/");
				System.out.println(DateofMonths[1]);
				
				currentmonth=DateofMonths[1];
				if(currentmonth.equalsIgnoreCase(previousmonth))
				{
					System.out.println("Error... Two EPS has been generated for the same month");
				}
				else
				{
					previousmonth=DateofMonths[1];
					System.out.println("Success...Single EPS is generated for every months");
				}
			}
			
		}
		
		TakeScreenshot.takeScreenshot(m_Driver, "Different FPS for different frequency when weekly employee has leaver");
