...
public class runpayrolldiffFreq extends BasePage
{
	public runpayrolldiffFreq (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	for(int i=0; i<=13;i++)
	{
		 ...
		 String freqText=m_Driver.findElement(By.xpath("")).getText();
	...
	public void Click_ClickRunPayroll2() throws Exception
	{
		...
		TakeScreenshot.takeScreenshot(m_Driver, "Weekly_Frequency");
