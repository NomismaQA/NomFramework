...
public class gotoPayrollDashboard extends BasePage
{
	public gotoPayrollDashboard (WebDriver driver)
	{
		super(driver);
	}
   ...
   public void AssertUrl()
	...
	public void Click_ClickPayroll() throws InterruptedException
	{
		...
		elem.click();
//         String str= m_Driver.findElement(By.xpath("//*[@id=\"ctl00_ctl00_ParentContent_ddlPayrollDate\"]")).getText();
...
//         }
//         
//		m_Driver.findElement(By.xpath("//*[@id='ctl00_ctl00_ParentContent_SideMenu1_hrefReports']/span")).click();
		Thread.sleep(1000); 
